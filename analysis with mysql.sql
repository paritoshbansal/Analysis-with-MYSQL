...
INSERT INTO bands VALUES (1,'Seventh Wonder');
INSERT INTO bands VALUES (2,'Metallica');
INSERT INTO bands VALUES (3,'The Ocean');
INSERT INTO bands VALUES (4,'Within Temptation');
INSERT INTO bands VALUES (5,'Death');
INSERT INTO bands VALUES (6,'Van Canto');
INSERT INTO bands VALUES (7,'Dream Theater');

INSERT INTO albums VALUES (1,'Tiara',2018,1);
INSERT INTO albums VALUES (2,'The Great Escape',2010,1);
INSERT INTO albums VALUES (3,'Mercy Falls',2008,1);
INSERT INTO albums VALUES (4,'Master of Puppets',NULL,2);
INSERT INTO albums VALUES (5,'...And Justice for All',1988,2);
INSERT INTO albums VALUES (6,'Death Magnetic',2008,2);
INSERT INTO albums VALUES (7,'Heliocentric',2010,3);
INSERT INTO albums VALUES (8,'Pelagial',2013,3);
INSERT INTO albums VALUES (9,'Anthropocentric',2010,3);
INSERT INTO albums VALUES (10,'Resist',2018,4);
INSERT INTO albums VALUES (11,'The Unforgiving',2011,4);
INSERT INTO albums VALUES (12,'Enter',1997,4);
INSERT INTO albums VALUES (13,'The Sound of Perseverance',1998,5);
INSERT INTO albums VALUES (14,'Individual Thought Patterns',1993,5);
INSERT INTO albums VALUES (15,'Human',1991,5);
INSERT INTO albums VALUES (16,'A Storm to Come',2006,6);
INSERT INTO albums VALUES (17,'Break the Silence',2011,6);
INSERT INTO albums VALUES (18,'Tribe of Force',2010,6);
...
FROM
    ALBUMS
		right JOIN
    BANDS ON ALBUMS.BAND_ID = BANDS.ID WHERE BAND_ID IS NOT NULL;
...
FROM
    ALBUMS
        RIGHT JOIN
    BANDS ON ALBUMS.BAND_ID = BANDS.ID WHERE BAND_ID IS NULL;
...
INSERT INTO BANDS VALUES(8,"COKE STUDIO");
INSERT INTO ALBUMS VALUES(19,"CHAUDHARY",2015,8);

# 9. Delete the Band and Album you added in previous question.
DELETE FROM ALBUMS WHERE ID=19;
DELETE FROM BANDS WHERE band_NAME="COKE STUDIO";
...
select * from albums;
select * from bands;
alter table albums rename column id to id_album;

# 12. Get the number of songs for each band
SELECT 
    band_id,count(band_id) as number_of_songs
FROM
    bands
        LEFT JOIN
    albums ON bands.id = albums.band_id
        RIGHT JOIN
    songs ON albums.id_album = songs.album_id 
    group by band_id;

# 13. Create a decade column with dividing the year // 10 *10.    
select *,release_year/10 as decade_year from albums ;

# 14. Filter the Albums which start with the word 'The
select * from albums where album_name like "the%";
